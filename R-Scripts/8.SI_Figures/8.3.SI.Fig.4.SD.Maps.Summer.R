##########################################################
#### SI FIG.4: SD maps of predictions in summer   #######
##########################################################
...
########################################
# load rasters in summer from best algo
########################################

#-----------------------------------
# current predictions from MEAN
#-----------------------------------
bel  <- readRDS("./RDATA/5.CARET/Mean_pred_3GCM/Summer/PredSD_3GCMs_ffs_6var_Summer_Bel_West.rds")
bwW  <- readRDS("./RDATA/5.CARET/Mean_pred_3GCM/Summer/PredSD_3GCMs_ffs_6var_Summer_Bw_West.rds")
bwE  <- readRDS("./RDATA/5.CARET/Mean_pred_3GCM/Summer/PredSD_3GCMs_ffs_6var_Summer_Bw_East.rds")
narW <- readRDS("./RDATA/5.CARET/Mean_pred_3GCM/Summer/PredSD_3GCMs_ffs_6var_Summer_Nar_West.rds")
narE <- readRDS("./RDATA/5.CARET/Mean_pred_3GCM/Summer/PredSD_3GCMs_ffs_6var_Summer_Nar_east.rds")


#--------------------------------------
# predictions in summer 2100 ssp126
#--------------------------------------
bel_2100_126  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjSD_3GCMs_ffs_6var_Summer2100_Bel_West_ssp126.rds")
bwW_2100_126  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjSD_3GCMs_ffs_6var_Summer2100_Bw_West_ssp126.rds")
bwE_2100_126  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjSD_3GCMs_ffs_6var_Summer2100_Bw_East_ssp126.rds")
narW_2100_126 <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjSD_3GCMs_ffs_6var_Summer2100_Nar_West_ssp126.rds")
narE_2100_126 <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjSD_3GCMs_ffs_6var_Summer2100_Nar_East_ssp126.rds")


#--------------------------------------
# predictions in summer 2100 ssp585
#--------------------------------------
bel_2100_585  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjSD_3GCMs_ffs_6var_Summer2100_Bel_West_ssp585.rds")
bwW_2100_585  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjSD_3GCMs_ffs_6var_Summer2100_Bw_West_ssp585.rds")
bwE_2100_585  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjSD_3GCMs_ffs_6var_Summer2100_Bw_East_ssp585.rds")
narW_2100_585 <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjSD_3GCMs_ffs_6var_Summer2100_Nar_West_ssp585.rds")
narE_2100_585 <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjSD_3GCMs_ffs_6var_Summer2100_Nar_East_ssp585.rds")




###############################################
# convert rasters to tibble
###############################################

#-------------------
# belugas in summer
#-------------------
bel     <-  as_tibble(rasterToPoints(bel))
bel$ssp = "Present"
bel2100_126 <-  as_tibble(rasterToPoints(bel_2100_126))
bel2100_126$ssp = "2100 (ssp126)"
bel2100_585 <-  as_tibble(rasterToPoints(bel_2100_585))
bel2100_585$ssp = "2100 (ssp585)"

west_bel      = rbind(bel, bel2100_126, bel2100_585)
west_bel$ssp  = factor(west_bel$ssp, 
                       levels=c("Present","2100 (ssp126)",
                                "2100 (ssp585)"))
west_bel$side = "West"
west_bel$sp   = "Belugas"
west_bel$sp   = factor(west_bel$sp)
west_bel$side = factor(west_bel$side)
...
# combine 3 species per side
#----------------------------
west = rbind(west_bel, west_bw, west_nar)
east = rbind(east_bw, east_nar)
summary(west$layer)

bel = ggplot(shore, aes(long, lat)) +
  geom_contour_filled(data=west[west$sp=="Belugas",], 
                      aes(x,y,z=layer), breaks=seq(0,0.5,by=0.1)) +
  ...
  theme(axis.text.y  = element_blank(),
        ...
        plot.margin = unit(c(-0.5,0.1,-1.3,-0.4),"cm"))  #top,right,bottom,left
...
bw = ggplot(shore, aes(long, lat)) +
  ...
  annotate("text", x=-70,y=67, label="BA", colour="black",size=2, angle=45) +
  annotate("text", x=33, y=74, label="SVB", colour="black",size=2) +
  labs(y="",x="",fill="SD",title="") + 
  theme(axis.text.y  = element_blank(),
        axis.text.x  = element_blank(),
        axis.ticks   = element_blank(),
        strip.background.x = element_blank(),#element_rect(fill="gray52", size=0.1),
        ...
        panel.background = element_blank(),
        panel.grid.major = element_line(colour="gray52", size=0.1),
        plot.margin = unit(c(-1.3,0.1,-1.5,-0.4),"cm")) #top,right,bottom,left

nar = ggplot(shore, aes(long, lat)) +
  geom_contour_filled(data=west[west$sp=="Narwhals",],
                      aes(x,y,z=layer), breaks=seq(0,1,by=0.1)) +
  ...
  theme(axis.text.y  = element_blank(),
        ...
        panel.background = element_blank(),
        panel.grid.major = element_line(colour="gray52", size=0.1),
        plot.margin = unit(c(-1.7,0.1,-1,-0.4),"cm")) #top,right,bottom,left

a1 = grid.arrange(bel, bw, nar, ncol=1)

a2 = ggdraw() +
  draw_plot(a1) +
  draw_image(png_bel, x=-0.240, y=0.17, scale=.19) +
  draw_image(png_bel, x=0.040,  y=0.17, scale=.19) +
  draw_image(png_bel, x=0.325,  y=0.17, scale=.19) +
  
  draw_image(png_bw, x=-0.24, y=-0.12, scale=.14) +
  draw_image(png_bw, x=0.04,  y=-0.12, scale=.14) +
  draw_image(png_bw, x=0.33,  y=-0.12, scale=.14) +
  
  draw_image(png_nar, x=-0.25, y=-0.38, scale=.18) +
  draw_image(png_nar, x=0.04,  y=-0.38, scale=.18) +
  draw_image(png_nar, x=0.32,  y=-0.38, scale=.18)

setwd("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3")
ggsave(filename="./PAPER/Science/2.Resubmission_March2022/Figures/SI.Fig.3.Maps.SD.Summer.pdf",
       width=6,height=3.5,units="in",dpi=400,family="Helvetica",a2)
