##########################################################
####      SI FIG.5: maps of SD predictions in WINTER #####
##########################################################
...
#-----------------------------------
bwW  <- readRDS("./RDATA/5.CARET/Mean_pred_3GCM/Winter/PredSD_3GCMs_ffs_6var_Winter_Bw_West.rds")
bwE  <- readRDS("./RDATA/5.CARET/Mean_pred_3GCM/Winter/PredSD_3GCMs_ffs_6var_Winter_Bw_East.rds")
narW <- readRDS("./RDATA/5.CARET/Mean_pred_3GCM/Winter/PredSD_3GCMs_ffs_6var_Winter_Nar_West.rds")
narE <- readRDS("./RDATA/5.CARET/Mean_pred_3GCM/Winter/PredSD_3GCMs_ffs_6var_Winter_Nar_east.rds")


#--------------------------------------
# predictions in Winter 2100 ssp126
#--------------------------------------
bwW_2100_126  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Winter/ProjSD_3GCMs_ffs_6var_Winter2100_Bw_West_ssp126.rds")
bwE_2100_126  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Winter/ProjSD_3GCMs_ffs_6var_Winter2100_Bw_East_ssp126.rds")
narW_2100_126 <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Winter/ProjSD_3GCMs_ffs_6var_Winter2100_Nar_West_ssp126.rds")
narE_2100_126 <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Winter/ProjSD_3GCMs_ffs_6var_Winter2100_Nar_East_ssp126.rds")


#--------------------------------------
# predictions in Winter 2100 ssp585
#--------------------------------------
bwW_2100_585  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Winter/ProjSD_3GCMs_ffs_6var_Winter2100_Bw_West_ssp585.rds")
bwE_2100_585  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Winter/ProjSD_3GCMs_ffs_6var_Winter2100_Bw_East_ssp585.rds")
narW_2100_585 <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Winter/ProjSD_3GCMs_ffs_6var_Winter2100_Nar_West_ssp585.rds")
narE_2100_585 <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Winter/ProjSD_3GCMs_ffs_6var_Winter2100_Nar_East_ssp585.rds")
...
setwd("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3")
ggsave(filename="./PAPER/Science/2.Resubmission_March2022/Figures/SI.Fig.4.Maps.SD.Winter.pdf",
