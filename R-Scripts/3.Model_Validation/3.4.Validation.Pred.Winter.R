      ...
      for (a in 1:7) {
        ...
        for (run in 1:10) {
          m = readRDS(paste0("./RDATA/5.CARET/",i,"/Summary_models/Winter/",model,
                             "/ffs_Winter_6var_",model,"_",i,"_run",run,".RDS"))
          mod = m[[a]]
...
system.time({  # 123 sec
  for (model in models) { 
    for (i in species) {
      files = list.files(paste0("./RDATA/5.CARET/",i,"/Predictions/Winter/",model), 
                         pattern="Pred_Winter")
      ...
      for (n in 1:length(files)) { 
        ...
        for (y in unique(dat$year)) {
          ...
          png(filename=paste0("./FIGURES/CARET/",i,
                              "/0.25deg/Predictions/Winter/",model,"/years/",
                              "PredStack_Winter_6var_10runs_year",y,"_",
                              i,"_",algo,".png"),
    ...
    for (i in species) { 
      ...
      for (a in algo) {
        ...
        saveRDS(max, file=paste0("./RDATA/5.CARET/",i,"/Predictions/Winter/",model,
                                 "/Average_6var/PredMax_ffs_Winter_6var_",model,"_",
                                 i,"_",a,".rds"))
        
        png(filename=paste0("./FIGURES/CARET/",i,"/0.25deg/Predictions/Winter/",model,
                            "/PredMax_ffs_Winter_6var_",model,"_",
                            i,"_",a,".png"),
        ...
        saveRDS(mean, file=paste0("./RDATA/5.CARET/",i,"/Predictions/Winter/",model,
                                  "/Average_6var/PredMean_ffs_Winter_6var_",model,"_",
                                  i,"_",a,".rds"))
        
        png(filename=paste0("./FIGURES/CARET/",i,"/0.25deg/Predictions/Winter/",model,
                            "/PredMean_ffs_Winter_6var_",model,"_",
                            i,"_",a,".png"),
            res=350,width=5, height=4.4,units="in")
        ...
        png(filename=paste0("./FIGURES/CARET/",i,"/0.25deg/Predictions/Winter/",model,
                            "/PredMedian_ffs_Winter_6var_",model,"_",
                            i,"_",a,".png"),
            res=350,width=5, height=4.4,units="in")
        ...
        png(filename=paste0("./FIGURES/CARET/",i,"/0.25deg/Predictions/Winter/",model,
                            "/PredSD_ffs_Winter_6var_",model,"_",
                            i,"_",a,".png"),
            res=350,width=5, height=4.4,units="in")
        ...
        saveRDS(cv, file=paste0("./RDATA/5.CARET/",i,"/Predictions/Winter/",model,
                                "/Average_6var/PredCV_ffs_Winter_6var_",model,"_",
                                i,"_",a,".rds"))
        
        png(filename=paste0("./FIGURES/CARET/",i,"/0.25deg/Predictions/Winter/",model,
                            "/PredCV_ffs_Winter_6var_",model,"_",
                            i,"_",a,".png"),
            res=350,width=5, height=4.4,units="in")
