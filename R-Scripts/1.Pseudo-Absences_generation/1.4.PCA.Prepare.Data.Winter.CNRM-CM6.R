...
#####       GCM: CNRM-CM6-1-HR, resolution: 0.25 deg, monthly
###################################################################
...
variable = "tos"
tos2 = NULL
files = list.files(paste0("./ENV.DATA/GCM/",model,"_25km/",variable,"/"),
                   pattern=ssp)
files
...
unique(mlotst2$year)
unique(mlotst2$month)
rm(dates,dates2,grid,var,var1,files,lat,lon,i,nc,t,variable)
...
system.time({  # 21 sec
  ...
  for (d in unique(yymm)) { 
    ...
    saveRDS(proj, file=paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3",
                              ...
                              "/Env_raster/Winter/Env_raster_6var_West_",model,"_",d,".rds"))
  }
})
...
# import bathy for masking land
#--------------------------------
env <- readRDS(paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3",
                      "/RDATA/3.ACP/0.25deg/Bw_East/Summer/Unscaled/",
...
system.time({  # 66 sec
  ...
  for (d in unique(yymm)) { 
    ...
    saveRDS(proj, file=paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3",
                              "/RDATA/3.ACP/6variables/",model,"/",i,
                              "/Env_raster/Winter/Env_raster_6var_",i,"_",model,"_",d,".rds"))
  }
})
...
ggsave(filename=paste0("./FIGURES/CLIMATO/GCM/",model,"/",
                       "Boxplot_tos_years_1993-2020_winter_",model,".png"),
