##########################################################
#### FIG.1: maps of predictions in summer & winter #######
##########################################################
...
#-----------------------------------
bel  <- readRDS("./RDATA/5.CARET/Mean_pred_3GCM/Summer/PredMean_3GCMs_ffs_6var_Summer_Bel_West.rds")
bwW  <- readRDS("./RDATA/5.CARET/Mean_pred_3GCM/Summer/PredMean_3GCMs_ffs_6var_Summer_Bw_West.rds")
bwE  <- readRDS("./RDATA/5.CARET/Mean_pred_3GCM/Summer/PredMean_3GCMs_ffs_6var_Summer_Bw_East.rds")
narW <- readRDS("./RDATA/5.CARET/Mean_pred_3GCM/Summer/PredMean_3GCMs_ffs_6var_Summer_Nar_West.rds")
narE <- readRDS("./RDATA/5.CARET/Mean_pred_3GCM/Summer/PredMean_3GCMs_ffs_6var_Summer_Nar_east.rds")


#--------------------------------------
# predictions in summer 2100 ssp126
#--------------------------------------
bel_2100_126  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjMean_3GCMs_ffs_6var_Summer2100_Bel_West_ssp126.rds")
bwW_2100_126  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjMean_3GCMs_ffs_6var_Summer2100_Bw_West_ssp126.rds")
bwE_2100_126  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjMean_3GCMs_ffs_6var_Summer2100_Bw_East_ssp126.rds")
narW_2100_126 <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjMean_3GCMs_ffs_6var_Summer2100_Nar_West_ssp126.rds")
narE_2100_126 <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjMean_3GCMs_ffs_6var_Summer2100_Nar_East_ssp126.rds")


#--------------------------------------
# predictions in summer 2100 ssp585
#--------------------------------------
bel_2100_585  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjMean_3GCMs_ffs_6var_Summer2100_Bel_West_ssp585.rds")
bwW_2100_585  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjMean_3GCMs_ffs_6var_Summer2100_Bw_West_ssp585.rds")
bwE_2100_585  <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjMean_3GCMs_ffs_6var_Summer2100_Bw_East_ssp585.rds")
narW_2100_585 <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjMean_3GCMs_ffs_6var_Summer2100_Nar_West_ssp585.rds")
narE_2100_585 <- readRDS("./RDATA/6.Climatic_projections/Mean_pred_3GCM/Summer/ProjMean_3GCMs_ffs_6var_Summer2100_Nar_East_ssp585.rds")
...
setwd("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3")
ggsave(filename="./PAPER/Science/2.Resubmission_March2022/Figures/Fig.1.Summer.pdf",
