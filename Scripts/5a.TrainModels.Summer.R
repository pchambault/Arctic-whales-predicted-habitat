...
######################################
# 1) loop over each species and side
######################################
cl <- parallel::makeCluster(5)
doParallel::registerDoParallel(cl)

system.time({ # 15796 sec (4h) with the mac with 7 algo
  for (i in species) { # 
    ...
    ######################################
      ...
      foreach(n=1:10) %dopar% {
        ...
        setwd("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3")
        saveRDS(train, file=paste0("./RDATA/5.CARET/",i,"/Summary_models/Summer/",
                                   model,"/split/train_Summer_6var_",model,"_",i,
                                   "_run",n,".rds"))
        saveRDS(valid, file=paste0("./RDATA/5.CARET/",i,"/Summary_models/Summer/",
                                   model,"/split/valid_Summer_6var_",model,"_",i,
                                   "_run",n,".rds"))
        saveRDS(test, file=paste0("./RDATA/5.CARET/",i,"/Summary_models/Summer/",
                                   model,"/split/test_Summer_6var_",model,"_",i,
                                  "_run",n,".rds"))
        ...
        setwd("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3")
        png(filename=paste0("./FIGURES/CARET/",i,"/Summary_Models/Summer/",
                            "Dotplot_spatialCV_ffs_Summer_6var_",model,"_",
                            i,"_run",n,".png"),
        ...
        saveRDS(results, file=paste0("./RDATA/5.CARET/",i,
                                     "/Summary_models/Summer/",model,
                                     "/Results_ffs_Summer_6var_",model,"_",
                                     i,"_run",n,".rds"))
