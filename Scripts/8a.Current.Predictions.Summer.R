...
system.time({ # 278 sec 
  for (model in models) {
    for (i in species) { 
      ...
      for (n in 1:10) {
        setwd("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3")
        files = list.files(paste0("./RDATA/5.CARET/",i,"/Summary_models/Summer/",model,
                                  "/Best_Model/"), pattern="BestModel")
        setwd(paste0("./RDATA/5.CARET/",i,"/Summary_models/Summer/",model,
                     "/Best_Model/"))
        mod = readRDS(files[[n]])
      ...
      saveRDS(stack,file=paste0("./RDATA/5.CARET/",i,
                                ...
                                "/Pred_Summer_6var_bestAlgo_",model,"_",
  ...
  for (model in models) { 
    for (i in species) {
      ...
      file = list.files(paste0("./RDATA/5.CARET/",i,"/Predictions/Summer/",model), 
                        pattern="Pred_Summer_6var_bestAlgo")
      ...
      for (y in unique(dat$year)) {
        ...
        png(filename=paste0("./FIGURES/CARET/",i,
                            "/0.25deg/Predictions/Summer/",model,"/years_bestAlgo/",
                            "PredStack_bestAlgo_Summer_6var_10runs_year",y,"_",
                            i,"_",algo,".png"),
  ...
  for (model in models) { 
    for (i in species) { 
      ...
      saveRDS(max, file=paste0("./RDATA/5.CARET/",i,"/Predictions/Summer/",model,
                               "/Average_6var_bestAlgo/PredMax_ffs_bestAlgo_Summer_6var_",
                               model,"_",i,".rds"))
      
      setwd("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3")
      png(filename=paste0("./FIGURES/CARET/",i,"/0.25deg/Predictions/Summer/",model,
                          "/bestAlgo/PredMax_ffs_bestAlgo_Summer_6var_",model,"_",
                          i,".png"),
      ...
      png(filename=paste0("./FIGURES/CARET/",i,"/0.25deg/Predictions/Summer/",model,
                          "/bestAlgo/PredMean_ffs_bestAlgo_Summer_6var_",model,"_",
                          i,".png"),
          res=350,width=5, height=4.4,units="in")
      ...
      saveRDS(median, file=paste0("./RDATA/5.CARET/",i,"/Predictions/Summer/",model,
                                  "/Average_6var_bestAlgo/PredMedian_ffs_bestAlgo_Summer_6var_",
                                  model,"_",i,".rds"))
      
      png(filename=paste0("./FIGURES/CARET/",i,"/0.25deg/Predictions/Summer/",model,
                          "/bestAlgo/PredMedian_ffs_bestAlgo_Summer_6var_",model,"_",
                          i,".png"),
          res=350,width=5, height=4.4,units="in")
      ...
      saveRDS(sd, file=paste0("./RDATA/5.CARET/",i,"/Predictions/Summer/",model,
                              "/Average_6var_bestAlgo/PredSD_ffs_bestAlgo_Summer_6var_",
                              model,"_",i,".rds"))
      
      png(filename=paste0("./FIGURES/CARET/",i,"/0.25deg/Predictions/Summer/",model,
                          "/bestAlgo/PredSD_ffs_bestAlgo_Summer_6var_",model,"_",
                          i,".png"),
          res=350,width=5, height=4.4,units="in")
      ...
      saveRDS(cv, file=paste0("./RDATA/5.CARET/",i,"/Predictions/Summer/",model,
                              "/Average_6var_bestAlgo/PredCV_ffs_bestAlgo_Summer_6var_",
                              model,"_", i,".rds"))
      
      png(filename=paste0("./FIGURES/CARET/",i,"/0.25deg/Predictions/Summer/",model,
                          "/bestAlgo/PredCV_ffs_bestAlgo_Summer_6var_",model,"_",
                          i,".png"),
          res=350,width=5, height=4.4,units="in")
