...
# choose species and locality of interest:
      ...
      for (i in sp) {
        for (n in 1:10) { 
          ...
          setwd(paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3",
                       "/RDATA/5.CARET/",i,"/Summary_models/Summer/",model,"/Best_Model/"))
          m = readRDS(files[[n]])
          ...
          #------------------------------
          setwd("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3")
          env = list.files(path=paste0("./RDATA/6.Climatic_projections/",model,
                                       "/Rasters/",i,"/Summer"),
                           pattern=ssp) 
          x <- stack()
          ...
          for (p in 1:length(env)) { 
            ...
            setwd(paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3/RDATA",
                         "/6.Climatic_projections/",model,"/Rasters/",i,"/Summer"))
            proj <- readRDS(env[[p]])
          ...
          saveRDS(x, file=paste0("./RDATA/6.Climatic_projections/",i,
                                 "/0.25deg/Summer/",model,"_",ssp,
                                 "/Proj_rasterStack_6var_Summer_",m$method,"_",
                                 model,"_",ssp,"_",i,
                                 "_run",n,".rds"))
          rm(x)
        }
      ...
      for (i in sp) {
        ...
        for (y in year) {
          ...
          saveRDS(mean, file=paste0("./RDATA/6.Climatic_projections/",i,
                                    "/0.25deg/Summer/",model,"_",ssp,"/Average_6var/",
                                    "ProjMean_Summer_0.25deg_6var_10runs_bestAlgo_",
                                    i,"_",y,".rds"))
          ...
          saveRDS(max, file=paste0("./RDATA/6.Climatic_projections/",i,
                                   "/0.25deg/Summer/",model,"_",ssp,"/Average_6var/",
                                   "ProjMax_Summer_0.25deg_6var_10runs_bestAlgo_",
                                   i,"_",y,".rds"))
          ...
          saveRDS(median, file=paste0("./RDATA/6.Climatic_projections/",i,
                                      "/0.25deg/Summer/",model,"_",ssp,"/Average_6var/",
                                      "ProjMedian_Summer_0.25deg_6var_10runs_bestAlgo_",
                                      i,"_",y,".rds"))
          ...
          saveRDS(sd, file=paste0("./RDATA/6.Climatic_projections/",i,
                                  "/0.25deg/Summer/",model,"_",ssp,"/Average_6var/",
                                  "ProjSD_Summer_0.25deg_6var_10runs_bestAlgo_",
                                  i,"_",y,".rds"))
    ...
    for (ssp in scenario) {
      for (i in sp) {
        files = list.files(paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3",
                                  "/RDATA/6.Climatic_projections/",i,"/0.25deg/Summer/",
        ...
        for (n in 1:10) { 
          ...
          png(filename=paste0("/Users/philippinechambault/Documents/POST-DOC/2021/",
                              "PAPER3/FIGURES/CLIMATO/",i,"/0.25deg/Summer/",model,
                              "_",ssp,"/runs/","Proj_Summer2020-2100_6var_bestAlgo_",
