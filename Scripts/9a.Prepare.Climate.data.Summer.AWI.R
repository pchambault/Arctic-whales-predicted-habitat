...
# run for each scenario separately
ssp   = scenario[1]
...
unique(mlotst2$year)
table(mlotst2$year, mlotst2$month)
...
system.time({  # 12 sec
  ...
  for (d in unique(yymm)) { 
    ...
    ##############################
    # values(tos_r)    <- scale2(values(tos_r))
    # values(sos_r)    <- scale2(values(sos_r))
    # values(zos_r)    <- scale2(values(zos_r))
...
for (i in sp) { 
  for (m in month) { 
    ...
    png(filename=paste0("./FIGURES/CLIMATO/GCM/",model,
                        "/Maps_tos/ProjStack_Summer_tos_2020-2100",m,"_",
                        i,"_",ssp,".png"),
        res=350, width=6, height=4.4,units="in")
    plot(sub, col = viridis(64),zlim=c(-2,15))
    dev.off()
  }
}
...
for (i in sp) { 
  for (m in month) { 
    ...
    setwd(paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3"))
    png(filename=paste0("./FIGURES/CLIMATO/GCM/",model,
                        "/Maps_sos/ProjStack_Summer_sos_2020-2100",m,"_",
                        i,"_",ssp,".png"),
        res=350, width=6, height=4.4,units="in")
...
for (i in sp) { 
  for (m in month) { 
    ...
    setwd(paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3"))
    png(filename=paste0("./FIGURES/CLIMATO/GCM/",model,
                        "/Maps_zos/ProjStack_Summer_zos_2020-2100",m,"_",
                        i,"_",ssp,".png"),
        res=350, width=6, height=4.4,units="in")
...
ggsave(filename=paste0("./FIGURES/CLIMATO/GCM/AWI-CM-1-1-MR/",
                       "Boxplot_tos_years_2020-2100_summer_",
                       model,"_",ssp,".png"),
...
ggplot(pivot, aes(x=year, y=val, colour=side)) +
  ...
  theme_tq() 
ggsave(filename=paste0("./FIGURES/CLIMATO/GCM/AWI-CM-1-1-MR/",
                       "Boxplot_sos_years_2020-2100_summer_",
                       model,"_",ssp,".png"),
       width=3.5,height=4,dpi=400,family="serif")
...
ggplot(pivot, aes(x=year, y=val, colour=side)) +
  ...
  theme_tq() 
ggsave(filename=paste0("./FIGURES/CLIMATO/GCM/AWI-CM-1-1-MR/",
                       "Boxplot_zos_years_2020-2100_summer_",
                       model,"_",ssp,".png"),
       width=3.5,height=4,dpi=400,family="serif")
...
ggplot(pivot, aes(x=year, y=val, colour=side)) +
  ...
  theme_tq() 
ggsave(filename=paste0("./FIGURES/CLIMATO/GCM/AWI-CM-1-1-MR/",
                       "Boxplot_mlotst_years_2020-2100_summer_",
                       model,"_",ssp,".png"),
       width=3.5,height=4,dpi=400,family="serif")
