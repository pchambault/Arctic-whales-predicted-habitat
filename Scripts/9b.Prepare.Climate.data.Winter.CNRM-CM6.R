...
system.time({    # 77 sec
  for (ssp in scenario) { 
    ...
    for (f in 1:length(files)) { 
      ...
      # retain only dates for decades and Winter
    ...
    saveRDS(tos2,file=paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3",
                             ...
                             "/tos_25km_",model,"_Winter_",ssp,"_2020-2100.rds"))
  }
})
...
system.time({    # 77 sec 
  for (ssp in scenario) { 
    ...
    saveRDS(sos2,file=paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3",
                             "/RDATA/6.Climatic_projections/",model,
                             "/sos_25km_",model,"_Winter_",ssp,"_2020-2100.rds"))
  }
})
...
system.time({    # 77 sec
  for (ssp in scenario) { 
    ...
    saveRDS(zos2,file=paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3",
                             "/RDATA/6.Climatic_projections/",model,
                             "/zos_25km_",model,"_Winter_",ssp,"_2020-2100.rds"))
  }
})
...
system.time({    # 80 sec 
  for (ssp in scenario) { 
    ...
    saveRDS(mlotst2,file=paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3",
                                "/RDATA/6.Climatic_projections/",model,
                                "/mlotst_25km_",model,"_Winter_",ssp,"_2020-2100.rds"))
  }
})
...
system.time({   # 86 sec
  for (ssp in scenario) { 
    ...
    mlotst <- readRDS(paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3/",
                             "RDATA/6.Climatic_projections/",model,"/mlotst_25km_",model,"_Winter_",
                             ssp,"_2020-2100.rds"))
    ...
    for (d in unique(yymm)) { 
      ...
      ##############################
      proj = stack(tos_r, zos_r, sos_r, mlotst_r, env[[4]], env[[5]]) # sss,ssh,sss,bathy,dist
      saveRDS(proj, file=paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3",
                                ...
                                "/Winter/Env_proj_",i,"_",model,"_Winter_",ssp,"_",d,".rds"))
      saveRDS(proj, file=paste0("/Users/philippinechambault/Documents/POST-DOC/2021/PAPER3",
                                "/RDATA/6.Climatic_projections/",model,"/Rasters/Nar_West",
                                "/Winter/Env_proj_Nar_West_",model,"_Winter_",ssp,"_",d,".rds"))
    }
...
ggplot(pivot, aes(x=year, y=val,colour=side)) +
  ...
  labs(y="deg C", x="Years",
       ...
       subtitle = paste0("Winter (",model,", ",ssp,")")) +
...
ggsave(filename=paste0("./FIGURES/CLIMATO/GCM/",model,
                       "/Boxplot_mlotst_years_",model,"_",ssp,
                       "_2020-2100_Winter.png"),
       width=3.5,height=4.5,dpi=400,family="serif")
