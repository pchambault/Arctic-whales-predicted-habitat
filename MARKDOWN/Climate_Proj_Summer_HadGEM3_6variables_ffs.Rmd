---
title: "Future projections from HadGEM3-GC31-MM model (6 variables, best algo from ffs)"
...
best = pivot %>%
  ...
  side == "East" & model == "glmboost" ~ "Highlighted"))
```
...
ggplot(best, aes(x=model, y=value, colour=type)) +
  ...
  theme(axis.title.y = element_text(size=7,color="black"),
        ...
        axis.text.y  = element_text(size=7,color="black"))
```
The _Random Forest_ suffers from overfitting, so the best algorithm is the _blackboost_ for narwhals East and West. 
...
best = pivot %>%
  filter(species=="Bel") %>%
  mutate(type = case_when(model == "blackboost" ~ "Highlighted"))
```
...
ggplot(best, aes(x=model, y=value, colour=type)) +
  ...
  theme(axis.title.y = element_text(size=7,color="black"),
        ...
        axis.text.y  = element_text(size=7,color="black"))
```
The best algo is the _blackboost_ for belugas.
...
```{r, echo=FALSE, fig.pos="placeHere", fig.height=4,fig.cap="\\label{fig:figs}Max prediction maps for belugas in present summer from the BRT."}
...
```{r, echo=FALSE, fig.pos="placeHere", fig.height=4,fig.cap="\\label{fig:figs}Mean projection maps for Belugas in summer 2030 from the BRT (ssp126)."}
ggplot(shore, aes(long, lat)) +
  geom_contour_filled(data=m, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  scale_fill_brewer(palette="BuPu") +
  coord_map("azequidistant", xlim=c(-105,-40), ylim=c(60,80)) +
...
```{r, echo=FALSE, fig.pos="placeHere", fig.height=4,fig.cap="\\label{fig:figs}Mean projection maps for Belugas in summer 2030 from the BRT (ssp585)."}
ggplot(shore, aes(long, lat)) +
  geom_contour_filled(data=m, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  scale_fill_brewer(palette="BuPu") +
  coord_map("azequidistant", xlim=c(-105,-40), ylim=c(60,80)) +
...
```{r, echo=FALSE, fig.pos="placeHere", fig.height=4,fig.cap="\\label{fig:figs}Mean projection maps for Belugas in summer 2060 from the BRT (ssp126)."}
ggplot(shore, aes(long, lat)) +
  geom_contour_filled(data=m, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  scale_fill_brewer(palette="BuPu") +
  coord_map("azequidistant", xlim=c(-105,-40), ylim=c(60,80)) +
...
```{r, echo=FALSE, fig.pos="placeHere", fig.height=4,fig.cap="\\label{fig:figs}Mean projection maps for Belugas in summer 2060 from the BRT (ssp585)."}
ggplot(shore, aes(long, lat)) +
  geom_contour_filled(data=m, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  scale_fill_brewer(palette="BuPu") +
  coord_map("azequidistant", xlim=c(-105,-40), ylim=c(60,80)) +
...
```{r, echo=FALSE, fig.pos="placeHere", fig.height=4,fig.cap="\\label{fig:figs}Mean projection maps for Belugas in summer 2100 from the BRT (ssp126)."}
ggplot(shore, aes(long, lat)) +
  geom_contour_filled(data=m, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  scale_fill_brewer(palette="BuPu") +
  coord_map("azequidistant", xlim=c(-105,-40), ylim=c(60,80)) +
...
```{r, echo=FALSE, fig.pos="placeHere", fig.height=4,fig.cap="\\label{fig:figs}Mean projection maps for Belugas in summer 2100 from the BRT (ssp585)."}
ggplot(shore, aes(long, lat)) +
  geom_contour_filled(data=m, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  scale_fill_brewer(palette="BuPu") +
  coord_map("azequidistant", xlim=c(-105,-40), ylim=c(60,80)) +
...
```{r, echo=FALSE, fig.pos="placeHere", fig.height=4,fig.cap="\\label{fig:figs}Mean prediction maps for Bowheads in present summer from the BRT and GLM"}
ggplot(shore, aes(long, lat)) +
  geom_contour_filled(data=west, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  geom_contour_filled(data=east, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  scale_fill_brewer(palette="BuPu") +
  ...
  labs(y="",x="",fill="Habitat \nsuitability",title="Bowheads",
       subtitle="Summer present, BRT and GLM") + 
  theme(axis.text.y  = element_blank(),
        axis.text.x  = element_blank(),
        axis.ticks   = element_blank(),
        strip.background = element_rect(fill="gray52", size=0.1),
...
```{r, echo=FALSE, fig.pos="placeHere", fig.height=4,fig.cap="\\label{fig:figs}Mean projection maps for Bowheads in summer 2030 from the BRT and GLM (ssp126)."}
ggplot(shore, aes(long, lat)) +
  geom_contour_filled(data=west, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  geom_contour_filled(data=east, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  scale_fill_brewer(palette="BuPu") + 
  ...
  geom_polygon(aes(group=group), fill="lightgrey",lwd=1) +
  labs(y="",x="",fill="Habitat \nsuitability",title="Bowheads",
       subtitle="Mean Summer 2030 (BRT and GLM, ssp126)") + 
  theme(axis.text.y  = element_blank(),
        axis.text.x  = element_blank(),
        axis.ticks   = element_blank(),
        strip.background = element_rect(fill="gray52", size=0.1),
...
```{r, echo=FALSE, fig.pos="placeHere", fig.height=4,fig.cap="\\label{fig:figs}Mean projection maps for Bowheads in summer 2030 from the BRT and GLM (ssp585)."}
ggplot(shore, aes(long, lat)) +
  geom_contour_filled(data=west, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  geom_contour_filled(data=east, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  scale_fill_brewer(palette="BuPu") + 
  ...
  geom_polygon(aes(group=group), fill="lightgrey",lwd=1) +
  labs(y="",x="",fill="Habitat \nsuitability",title="Bowheads",
       subtitle="Mean Summer 2030 (BRT and GLM, ssp585)") + 
  theme(axis.text.y  = element_blank(),
        axis.text.x  = element_blank(),
        axis.ticks   = element_blank(),
        strip.background = element_rect(fill="gray52", size=0.1),
...
```{r, echo=FALSE, fig.pos="placeHere", fig.height=4,fig.cap="\\label{fig:figs}Mean projection maps for Bowheads in summer 2100 from the BRT and GLM (ssp126)."}
ggplot(shore, aes(long, lat)) +
  geom_contour_filled(data=west, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  geom_contour_filled(data=east, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  scale_fill_brewer(palette="BuPu") + 
  ...
  geom_polygon(aes(group=group), fill="lightgrey",lwd=1) +
  labs(y="",x="",fill="Habitat \nsuitability",title="Bowheads",
       subtitle="Mean Summer 2100 (BRT and GLM, ssp126)") + 
  theme(axis.text.y  = element_blank(),
        axis.text.x  = element_blank(),
        axis.ticks   = element_blank(),
        strip.background = element_rect(fill="gray52", size=0.1),
...
```{r, echo=FALSE, fig.pos="placeHere", fig.height=4,fig.cap="\\label{fig:figs}Mean projection maps for Bowheads in summer 2100 from the BRT and GLM (ssp585)."}
ggplot(shore, aes(long, lat)) +
  geom_contour_filled(data=west, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  geom_contour_filled(data=east, aes(x,y,z=layer), breaks=seq(0,1,by=0.2)) +
  scale_fill_brewer(palette="BuPu") + 
  ...
  geom_polygon(aes(group=group), fill="lightgrey",lwd=1) +
  labs(y="",x="",fill="Habitat \nsuitability",title="Bowheads",
       subtitle="Mean Summer 2100 (BRT and GLM, ssp585)") + 
  theme(axis.text.y  = element_blank(),
        axis.text.x  = element_blank(),
        axis.ticks   = element_blank(),
        strip.background = element_rect(fill="gray52", size=0.1),
